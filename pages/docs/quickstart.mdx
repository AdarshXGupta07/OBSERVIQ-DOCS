...
Go to [symphonious-sunburst-bcd1a4.netlify.app/signup](https://symphonious-sunburst-bcd1a4.netlify.app/signup) and register a new team.
...
Open your [ObservIQ dashboard](https://symphonious-sunburst-bcd1a4.netlify.app/login) and log in with your API key. Within seconds you'll see:
